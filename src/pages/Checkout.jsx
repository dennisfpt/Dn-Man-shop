...
export default function Checkout() {
  ...
  // Require an account to check out — send guests to /login and bring
  // them back here once they've signed in.
  if (!isAuthenticated) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-2xl sm:text-3xl font-semibold mb-10">Checkout</h1>
